...
mixin _$MealDetailsModel {
 ...
 String get mealName; String get description; double get calories; double get protein; double get carbs; double get fat; double get fiber; double get otherNutrients; List<String> get ingredientsList;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mealName,description,calories,protein,carbs,fat,fiber,otherNutrients,const DeepCollectionEquality().hash(ingredientsList));

@override
String toString() {
  return 'MealDetailsModel(mealName: $mealName, description: $description, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat, fiber: $fiber, otherNutrients: $otherNutrients, ingredientsList: $ingredientsList)';
}
...
@useResult
$Res call({
 String mealName, String description, double calories, double protein, double carbs, double fat, double fiber, double otherNutrients, List<String> ingredientsList
});
...
/// Create a copy of MealDetailsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mealName = null,Object? description = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? fiber = null,Object? otherNutrients = null,Object? ingredientsList = null,}) {
  return _then(_self.copyWith(
mealName: null == mealName ? _self.mealName : mealName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String mealName,  String description,  double calories,  double protein,  double carbs,  double fat,  double fiber,  double otherNutrients,  List<String> ingredientsList)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MealDetailsModel() when $default != null:
return $default(_that.mealName,_that.description,_that.calories,_that.protein,_that.carbs,_that.fat,_that.fiber,_that.otherNutrients,_that.ingredientsList);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String mealName,  String description,  double calories,  double protein,  double carbs,  double fat,  double fiber,  double otherNutrients,  List<String> ingredientsList)  $default,) {final _that = this;
switch (_that) {
case _MealDetailsModel():
return $default(_that.mealName,_that.description,_that.calories,_that.protein,_that.carbs,_that.fat,_that.fiber,_that.otherNutrients,_that.ingredientsList);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String mealName,  String description,  double calories,  double protein,  double carbs,  double fat,  double fiber,  double otherNutrients,  List<String> ingredientsList)?  $default,) {final _that = this;
switch (_that) {
case _MealDetailsModel() when $default != null:
return $default(_that.mealName,_that.description,_that.calories,_that.protein,_that.carbs,_that.fat,_that.fiber,_that.otherNutrients,_that.ingredientsList);case _:
  return null;
...
class _MealDetailsModel implements MealDetailsModel {
  const _MealDetailsModel({required this.mealName, required this.description, required this.calories, required this.protein, required this.carbs, required this.fat, required this.fiber, required this.otherNutrients, required final  List<String> ingredientsList}): _ingredientsList = ingredientsList;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mealName,description,calories,protein,carbs,fat,fiber,otherNutrients,const DeepCollectionEquality().hash(_ingredientsList));
...
/// Create a copy of MealDetailsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mealName = null,Object? description = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? fiber = null,Object? otherNutrients = null,Object? ingredientsList = null,}) {
